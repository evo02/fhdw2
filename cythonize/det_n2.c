...
#define __PYX_HAVE__det_n2
#define __PYX_HAVE_API__det_n2
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static void (*__pyx_f_5scipy_6linalg_13cython_lapack_dgetrf)(int *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *, int *); /*proto*/
static void (*__pyx_f_5scipy_6linalg_13cython_lapack_dgetri)(int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *); /*proto*/
...
/* Module declarations from 'det_n2' */
...
static double __pyx_f_6det_n2_det_p1(int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_6det_n2_inv_p1(int, int, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_6det_n2_det_m1(int, int, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_6det_n2_inv_m1(int, int, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_6det_n2_det_r(int, int, __Pyx_memviewslice, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_6det_n2_inv_r(int, int, __Pyx_memviewslice, int, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_6det_n2_full_inv(int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static double __pyx_f_6det_n2_det_p2(int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "det_n2"
extern int __pyx_module_is_main_det_n2;
int __pyx_module_is_main_det_n2 = 0;

/* Implementation of 'det_n2' */
...
static PyObject *__pyx_pf_6det_n2_det_p1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_z, double __pyx_v_s); /* proto */
static PyObject *__pyx_pf_6det_n2_2inv_p1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z); /* proto */
static PyObject *__pyx_pf_6det_n2_4det_m1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c); /* proto */
static PyObject *__pyx_pf_6det_n2_6inv_m1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c); /* proto */
static PyObject *__pyx_pf_6det_n2_8det_r(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, __Pyx_memviewslice __pyx_v_v); /* proto */
static PyObject *__pyx_pf_6det_n2_10inv_r(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z); /* proto */
static PyObject *__pyx_pf_6det_n2_12full_inv(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a); /* proto */
static PyObject *__pyx_pf_6det_n2_14det_p2(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_s, __Pyx_memviewslice __pyx_v_c); /* proto */
...
static PyObject *__pyx_pw_6det_n2_1det_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_6det_n2_det_p1(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_z, double __pyx_v_s, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  __pyx_v_a0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ) + __pyx_t_2 * __pyx_v_a.strides[1]) ))));
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_v_u.shape[0];
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_v_u.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_dgemv(((char *)"N"), (&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_alpha), __pyx_v_a0, (&__pyx_v_lda), (&(*((double *) ( /* dim=0 */ (__pyx_v_u.data + __pyx_t_2 * __pyx_v_u.strides[0]) )))), (&__pyx_v_incx), (&__pyx_v_beta), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_1 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incy));
 ...
 */
  ...
  __pyx_r = (__pyx_v_s - __pyx_f_5scipy_6linalg_11cython_blas_ddot((&__pyx_v_pm), (&(*((double *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_1 * __pyx_v_v.strides[0]) )))), (&__pyx_v_incx), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_2 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incy)));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.det_p1", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_1det_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_det_p1[] = "\n    Det: add a row & a column\n\n    integer :: lda, pm       ! leading dimension and actual size of A\n    double  :: a(lda,lda)\n    double  :: v(lda), u(lda), z(lda), s\n\n    Input: \n        a(lda,lda), s, v(lda), u(lda)\n        all arrays are of the size pm<lda \n\n    Output: \n        z(lda)\n        det. ratio @ det_p1\n    ";
static PyObject *__pyx_pw_6det_n2_1det_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  ...
  __Pyx_RefNannySetupContext("det_p1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_u,&__pyx_n_s_v,&__pyx_n_s_z,&__pyx_n_s_s,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pm)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 2); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_u)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 3); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 4); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 5); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_s)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, 6); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "det_p1") < 0)) __PYX_ERR(0, 16, __pyx_L3_error)
      }
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_u = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_u.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_s = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_s == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("det_p1", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.det_p1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_det_p1(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_u, __pyx_v_v, __pyx_v_z, __pyx_v_s);
...
static PyObject *__pyx_pf_6det_n2_det_p1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_z, double __pyx_v_s) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("det_p1", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 16, __pyx_L1_error) }
  if (unlikely(!__pyx_v_u.memview)) { __Pyx_RaiseUnboundLocalError("u"); __PYX_ERR(0, 16, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v.memview)) { __Pyx_RaiseUnboundLocalError("v"); __PYX_ERR(0, 16, __pyx_L1_error) }
  if (unlikely(!__pyx_v_z.memview)) { __Pyx_RaiseUnboundLocalError("z"); __PYX_ERR(0, 16, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6det_n2_det_p1(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_u, __pyx_v_v, __pyx_v_z, __pyx_v_s, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static PyObject *__pyx_pw_6det_n2_3inv_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6det_n2_inv_p1(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_rho;
  double __pyx_v_alpha;
  double __pyx_v_beta;
  int __pyx_v_incx;
 ...
 */
  ...
  if (__pyx_t_1 < 0) {
    ...
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_w.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 66, __pyx_L1_error)
  }
  __pyx_f_5scipy_6linalg_11cython_blas_dgemv(((char *)"T"), (&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_alpha), __pyx_v_a0, (&__pyx_v_lda), (&(*((double *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_2 * __pyx_v_v.strides[0]) )))), (&__pyx_v_incx), (&__pyx_v_beta), (&(*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_1 * __pyx_v_w.strides[0]) )))), (&__pyx_v_incy));
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_v_w.shape[0];
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_v_w.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 70, __pyx_L1_error)
  }
  __pyx_f_5scipy_6linalg_11cython_blas_dger((&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_rho), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_1 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incx), (&(*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_2 * __pyx_v_w.strides[0]) )))), (&__pyx_v_incy), __pyx_v_a0, (&__pyx_v_lda));
 ...
 */
  __pyx_v_size_n = (__pyx_v_a.shape[0]);
 ...
 */
  __pyx_v_size_m = (__pyx_v_a.shape[1]);
 ...
 */
  ...
  } else if (unlikely(__pyx_t_1 >= __pyx_v_a.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 76, __pyx_L1_error)
  }
  __pyx_v_a1 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) ))));
 ...
 */
  ...
  __pyx_v_a2 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ) + __pyx_t_2 * __pyx_v_a.strides[1]) ))));
 ...
 */
  __pyx_f_5scipy_6linalg_11cython_blas_dscal((&__pyx_v_pm), (&__pyx_v_beta), __pyx_v_a1, (&__pyx_v_lda));
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_daxpy((&__pyx_v_pm), (&__pyx_v_rho0), (&(*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_2 * __pyx_v_w.strides[0]) )))), (&__pyx_v_incx), __pyx_v_a1, (&__pyx_v_lda));
 ...
 * 
 */
  __pyx_f_5scipy_6linalg_11cython_blas_dscal((&__pyx_v_pm), (&__pyx_v_beta), __pyx_v_a2, (&__pyx_v_incx));
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_daxpy((&__pyx_v_pm), (&__pyx_v_rho0), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_2 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incx), __pyx_v_a2, (&__pyx_v_incy));
 ...
 *     #update pm
 */
  __pyx_t_2 = (__pyx_v_pm + 1);
  __pyx_t_1 = (__pyx_v_pm + 1);
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_v_a.shape[0];
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  ...
  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) )) = __pyx_v_rho;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.inv_p1", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_3inv_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_2inv_p1[] = "\n    Add row & column: update the inverse\n\n    integer :: lda, pm       ! leading dimension and actual size of A\n    double  :: a(lda,lda),det,v(lda),w(lda),z(lda) \n\n    Input: a(lda,lda), v(lda)\n        z(lda), det --- as set by det_p1 \n        all arrays are of the size pm<lda \n\n    Output: a(lda,lda) ==> (pm+1) * (pm+1) inverse\n        pm = pm( @ input) + 1\n    ";
static PyObject *__pyx_pw_6det_n2_3inv_p1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_det;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inv_p1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_det,&__pyx_n_s_v,&__pyx_n_s_w,&__pyx_n_s_z,0};
    PyObject* values[7] = {0,0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 1); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 2); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_det)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 3); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 4); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 5); __PYX_ERR(0, 44, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, 6); __PYX_ERR(0, 44, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inv_p1") < 0)) __PYX_ERR(0, 44, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 7) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_det = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_det == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_w.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 44, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inv_p1", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 44, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.inv_p1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_2inv_p1(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_det, __pyx_v_v, __pyx_v_w, __pyx_v_z);
...
static PyObject *__pyx_pf_6det_n2_2inv_p1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("inv_p1", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 44, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v.memview)) { __Pyx_RaiseUnboundLocalError("v"); __PYX_ERR(0, 44, __pyx_L1_error) }
  if (unlikely(!__pyx_v_w.memview)) { __Pyx_RaiseUnboundLocalError("w"); __PYX_ERR(0, 44, __pyx_L1_error) }
  if (unlikely(!__pyx_v_z.memview)) { __Pyx_RaiseUnboundLocalError("z"); __PYX_ERR(0, 44, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6det_n2_inv_p1(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_det, __pyx_v_v, __pyx_v_w, __pyx_v_z, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_5det_m1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_6det_n2_det_m1(int __pyx_v_pm, CYTHON_UNUSED int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_s;
  double __pyx_v_alpha;
  double __pyx_r;
  int __pyx_t_1;
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_c != __pyx_v_pm) != 0);
  if (__pyx_t_1) {
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_v_r != __pyx_v_pm) != 0);
  if (__pyx_t_1) {
 ...
 */
  ...
  } else if (unlikely(__pyx_t_2 >= __pyx_v_a.shape[0])) __pyx_t_4 = 0;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_a.shape[1];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_4 = 1;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_a.shape[1])) __pyx_t_4 = 1;
  if (unlikely(__pyx_t_4 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_4);
    __PYX_ERR(0, 118, __pyx_L1_error)
  }
  __pyx_t_5 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_3 * __pyx_v_a.strides[1]) )));
  ...
  __pyx_v_alpha = (__pyx_v_alpha * (__pyx_v_s / __pyx_t_5));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.det_m1", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_5det_m1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_4det_m1[] = "\n    Det: drop r-th row & c-th column\n\n    double function  det_m1(pm,lda,a,r,c)\n    integer :: pm,lda       ! actual size & leading dimension of A\n    double  :: a(lda,lda)    \n\tinteger:: c,r\n\tinteger :: s\n\n    Input:  a(lda,lda), pm\n    Output: det. ratio:  det BIG / det SMALL (=1/rho)\n    ";
static PyObject *__pyx_pw_6det_n2_5det_m1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_r;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("det_m1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_r,&__pyx_n_s_c,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("det_m1", 1, 5, 5, 1); __PYX_ERR(0, 96, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_m1", 1, 5, 5, 2); __PYX_ERR(0, 96, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_m1", 1, 5, 5, 3); __PYX_ERR(0, 96, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_m1", 1, 5, 5, 4); __PYX_ERR(0, 96, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "det_m1") < 0)) __PYX_ERR(0, 96, __pyx_L3_error)
      }
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 96, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 96, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 96, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_r == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 96, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 96, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("det_m1", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 96, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.det_m1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_4det_m1(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_c);
...
static PyObject *__pyx_pf_6det_n2_4det_m1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("det_m1", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 96, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6det_n2_det_m1(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_c, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_7inv_m1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6det_n2_inv_m1(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_incx;
  int __pyx_v_incy;
  double *__pyx_v_a0;
  double *__pyx_v_a1;
 ...
 */
  ...
  __pyx_v_a3 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) ))));
 ...
 */
  ...
  __pyx_v_a_full = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ) + __pyx_t_2 * __pyx_v_a.strides[1]) ))));
 ...
 */
  __pyx_t_4 = ((__pyx_v_c != __pyx_v_pm) != 0);
  if (__pyx_t_4) {
 ...
 */
    __pyx_f_5scipy_6linalg_11cython_blas_dswap((&__pyx_v_pm), __pyx_v_a0, (&__pyx_v_lda), __pyx_v_a1, (&__pyx_v_lda));
 ...
 */
  __pyx_t_4 = ((__pyx_v_r != __pyx_v_pm) != 0);
  if (__pyx_t_4) {
 ...
 */
    __pyx_f_5scipy_6linalg_11cython_blas_dswap((&__pyx_v_pm), __pyx_v_a2, (&__pyx_v_incx), __pyx_v_a3, (&__pyx_v_incy));
 ...
 */
  ...
  __pyx_t_5 = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) )));
  if (unlikely(__pyx_t_5 == 0)) {
    #ifdef WITH_THREAD
    PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
    #endif
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_dger((&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_rh), (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ) + __pyx_t_2 * __pyx_v_a.strides[1]) )))), (&__pyx_v_incx), (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_6 * __pyx_v_a.strides[0]) ) + __pyx_t_7 * __pyx_v_a.strides[1]) )))), (&__pyx_v_lda), __pyx_v_a_full, (&__pyx_v_lda));
...
static PyObject *__pyx_pw_6det_n2_7inv_m1(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inv_m1 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_r,&__pyx_n_s_c,0};
    PyObject* values[5] = {0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("inv_m1", 1, 5, 5, 1); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_m1", 1, 5, 5, 2); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_m1", 1, 5, 5, 3); __PYX_ERR(0, 121, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_m1", 1, 5, 5, 4); __PYX_ERR(0, 121, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inv_m1") < 0)) __PYX_ERR(0, 121, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 5) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_r == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inv_m1", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 121, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.inv_m1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_6inv_m1(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_c);
...
static PyObject *__pyx_pf_6det_n2_6inv_m1(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, int __pyx_v_c) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("inv_m1", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 121, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6det_n2_inv_m1(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_c, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_9det_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_6det_n2_det_r(int __pyx_v_pm, CYTHON_UNUSED int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, __Pyx_memviewslice __pyx_v_v, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_alpha;
  int __pyx_v_incx;
  int __pyx_v_incy;
  double *__pyx_v_r0;
 ...
 */
  ...
  __pyx_v_r0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ) + __pyx_t_2 * __pyx_v_a.strides[1]) ))));
 ...
 */
  ...
  __pyx_r = (__pyx_v_alpha + __pyx_f_5scipy_6linalg_11cython_blas_ddot((&__pyx_v_pm), (&(*((double *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_2 * __pyx_v_v.strides[0]) )))), (&__pyx_v_incx), __pyx_v_r0, (&__pyx_v_incy)));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.det_r", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_9det_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_8det_r[] = "\n    Det: change a single row\n    \n\tinteger :: lda, pm       ! leading dimension and actual size of A\n\tdouble  :: a(lda,lda), v(lda)\n    integer :: r\n    \n    Input: \n        a(lda,lda) --- inverse matrix\n        v(lda)     --- a row to be added\n        r          --- a row number \n        all arrays are of the size pm<lda \n\n    Output:\n        det. ratio @ det_r\n    ";
static PyObject *__pyx_pw_6det_n2_9det_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_r;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("det_r (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_r,&__pyx_n_s_v,0};
    PyObject* values[5] = {0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("det_r", 1, 5, 5, 1); __PYX_ERR(0, 179, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_r", 1, 5, 5, 2); __PYX_ERR(0, 179, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_r", 1, 5, 5, 3); __PYX_ERR(0, 179, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_r", 1, 5, 5, 4); __PYX_ERR(0, 179, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "det_r") < 0)) __PYX_ERR(0, 179, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 5) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 179, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 179, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 179, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_r == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 179, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 179, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("det_r", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 179, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.det_r", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_8det_r(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_v);
...
static PyObject *__pyx_pf_6det_n2_8det_r(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, __Pyx_memviewslice __pyx_v_v) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("det_r", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 179, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v.memview)) { __Pyx_RaiseUnboundLocalError("v"); __PYX_ERR(0, 179, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6det_n2_det_r(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_v, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 179, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_11inv_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6det_n2_inv_r(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_rho;
  int __pyx_v_incx;
  int __pyx_v_incy;
  double __pyx_v_alpha;
 ...
 */
  ...
  __pyx_v_a_r = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) ))));
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_dcopy((&__pyx_v_pm), __pyx_v_a_r, (&__pyx_v_incx), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_1 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incy));
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_dgemv(((char *)"T"), (&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_alpha), __pyx_v_a0, (&__pyx_v_lda), (&(*((double *) ( /* dim=0 */ (__pyx_v_v.data + __pyx_t_1 * __pyx_v_v.strides[0]) )))), (&__pyx_v_incx), (&__pyx_v_beta), (&(*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_2 * __pyx_v_w.strides[0]) )))), (&__pyx_v_incy));
 ...
 */
  ...
  __pyx_f_5scipy_6linalg_11cython_blas_dger((&__pyx_v_pm), (&__pyx_v_pm), (&__pyx_v_rho), (&(*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_2 * __pyx_v_z.strides[0]) )))), (&__pyx_v_incx), (&(*((double *) ( /* dim=0 */ (__pyx_v_w.data + __pyx_t_1 * __pyx_v_w.strides[0]) )))), (&__pyx_v_incy), __pyx_v_a0, (&__pyx_v_lda));
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.inv_r", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}

/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_11inv_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_10inv_r[] = "\n    inv: change a single row\n\n    integer :: lda, pm       ! leading dimension and actual size of A\n\tdouble  :: a(lda,lda), v(lda),w(lda),z(lda),det\n    integer :: r\n    double  :: rho\n\n    Input: \n        a(lda,lda)      --- inverse matrix\n        v(lda)          --- a row to be added\n        w(lda),z(lda)   --- working arrays\n        r               --- row number \n        det             --- det ratio, as set by det_r\n            all arrays are of the size pm<lda \n\n    Output:\n        a(lda,lda) contains an updated inverse matrix\n    ";
static PyObject *__pyx_pw_6det_n2_11inv_r(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_r;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inv_r (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_r,&__pyx_n_s_det,&__pyx_n_s_v,&__pyx_n_s_w,&__pyx_n_s_z,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 1); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 2); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 3); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_det)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 4); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 5); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 6); __PYX_ERR(0, 205, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, 7); __PYX_ERR(0, 205, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inv_r") < 0)) __PYX_ERR(0, 205, __pyx_L3_error)
      }
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_r == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_det = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_det == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_w.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 205, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inv_r", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 205, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.inv_r", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_10inv_r(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_det, __pyx_v_v, __pyx_v_w, __pyx_v_z);
...
static PyObject *__pyx_pf_6det_n2_10inv_r(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, int __pyx_v_r, double __pyx_v_det, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_w, __Pyx_memviewslice __pyx_v_z) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("inv_r", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 205, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v.memview)) { __Pyx_RaiseUnboundLocalError("v"); __PYX_ERR(0, 205, __pyx_L1_error) }
  if (unlikely(!__pyx_v_w.memview)) { __Pyx_RaiseUnboundLocalError("w"); __PYX_ERR(0, 205, __pyx_L1_error) }
  if (unlikely(!__pyx_v_z.memview)) { __Pyx_RaiseUnboundLocalError("z"); __PYX_ERR(0, 205, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6det_n2_inv_r(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_r, __pyx_v_det, __pyx_v_v, __pyx_v_w, __pyx_v_z, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_13full_inv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_6det_n2_full_inv(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_info;
  int __pyx_v_lwork;
 ...
 *     cdef:
 */
  if (unlikely(!__pyx_v_ipiv.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("ipiv"); __PYX_ERR(0, 280, __pyx_L1_error) }
  __pyx_t_2 = 0;
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_v_ipiv.shape[0];
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_v_ipiv.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 280, __pyx_L1_error)
  }
  __pyx_f_5scipy_6linalg_13cython_lapack_dgetrf((&__pyx_v_pm), (&__pyx_v_pm), __pyx_v_a0, (&__pyx_v_lda), (&(*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_2 * __pyx_v_ipiv.strides[0]) )))), (&__pyx_v_info));
 ...
 */
    ...
    } else if (unlikely(__pyx_t_1 >= __pyx_v_a.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_6);
      __PYX_ERR(0, 286, __pyx_L1_error)
    }
    __pyx_v_res = (__pyx_v_res * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_2 * __pyx_v_a.strides[0]) ) + __pyx_t_1 * __pyx_v_a.strides[1]) ))));
 ...
 *         if icnt%2 == 1:
 */
    if (unlikely(!__pyx_v_ipiv.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("ipiv"); __PYX_ERR(0, 287, __pyx_L1_error) }
    __pyx_t_1 = __pyx_v_i;
    __pyx_t_6 = -1;
    if (__pyx_t_1 < 0) {
      __pyx_t_1 += __pyx_v_ipiv.shape[0];
      if (unlikely(__pyx_t_1 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_1 >= __pyx_v_ipiv.shape[0])) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_6);
      __PYX_ERR(0, 287, __pyx_L1_error)
    }
    __pyx_t_7 = (((*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_1 * __pyx_v_ipiv.strides[0]) ))) != __pyx_v_i) != 0);
    if (__pyx_t_7) {
 ...
 */
    __pyx_t_7 = ((__Pyx_mod_long(__pyx_v_icnt, 2) == 1) != 0);
    if (__pyx_t_7) {
 ...
 *         return -1
 */
  if (unlikely(!__pyx_v_ipiv.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("ipiv"); __PYX_ERR(0, 291, __pyx_L1_error) }
  __pyx_t_1 = 0;
  __pyx_t_3 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_ipiv.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_ipiv.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 291, __pyx_L1_error)
  }
  if (unlikely(!__pyx_v_work.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("work"); __PYX_ERR(0, 291, __pyx_L1_error) }
  __pyx_t_2 = 0;
  __pyx_t_3 = -1;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_v_work.shape[0];
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_v_work.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 291, __pyx_L1_error)
  }
  __pyx_f_5scipy_6linalg_13cython_lapack_dgetri((&__pyx_v_pm), __pyx_v_a0, (&__pyx_v_lda), (&(*((int *) ( /* dim=0 */ (__pyx_v_ipiv.data + __pyx_t_1 * __pyx_v_ipiv.strides[0]) )))), (&(*((double *) ( /* dim=0 */ (__pyx_v_work.data + __pyx_t_2 * __pyx_v_work.strides[0]) )))), (&__pyx_v_lwork), (&__pyx_v_info));
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.full_inv", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_ipiv, 0);
  __PYX_XDEC_MEMVIEW(&__pyx_v_work, 0);
  return __pyx_r;
}

/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_13full_inv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_12full_inv[] = "\n    inv & det of a matrix (honest N**3)\n\n    integer :: lda, pm  ! leading dimension and actual size of A\n    double  :: a(lda,lda)\n\n    integer, allocatable :: ipiv(:)\n    double, allocatable :: work(:)\n    integer :: info, i,lwork,icnt\n\n    Input: \n        A(lda,lda), pm<lda \n\n    Output: \n        A contains the inverse\n        full_inv contains the determinant\n\n    ";
static PyObject *__pyx_pw_6det_n2_13full_inv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("full_inv (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("full_inv", 1, 3, 3, 1); __PYX_ERR(0, 251, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("full_inv", 1, 3, 3, 2); __PYX_ERR(0, 251, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "full_inv") < 0)) __PYX_ERR(0, 251, __pyx_L3_error)
      }
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 251, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 251, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 251, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("full_inv", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 251, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.full_inv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_12full_inv(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a);
...
static PyObject *__pyx_pf_6det_n2_12full_inv(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("full_inv", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 251, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6det_n2_full_inv(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 251, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_6det_n2_15det_p2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_6det_n2_det_p2(int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_s, __Pyx_memviewslice __pyx_v_c, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  double __pyx_v_alpha;
  double __pyx_v_beta;
  double __pyx_v_zalpha;
  double *__pyx_v_a0;
  double *__pyx_v_u0;
  double *__pyx_v_v0;
  double *__pyx_v_s0;
 ...
 */
  ...
  if (__pyx_t_1 < 0) {
    ...
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_u.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 318, __pyx_L1_error)
  }
  __pyx_v_u0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_u.data + __pyx_t_2 * __pyx_v_u.strides[0]) ) + __pyx_t_1 * __pyx_v_u.strides[1]) ))));
 ...
 */
  ...
  __pyx_v_v0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_v.data + __pyx_t_1 * __pyx_v_v.strides[0]) ) + __pyx_t_2 * __pyx_v_v.strides[1]) ))));
 ...
 */
  ...
  if (__pyx_t_2 < 0) {
    ...
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_2 >= __pyx_v_s.shape[0])) __pyx_t_3 = 0;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_s.shape[1];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_s.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 320, __pyx_L1_error)
  }
  __pyx_v_s0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s.data + __pyx_t_2 * __pyx_v_s.strides[0]) ) + __pyx_t_1 * __pyx_v_s.strides[1]) ))));
 ...
 */
  ...
  __pyx_v_c0 = (&(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_c.data + __pyx_t_1 * __pyx_v_c.strides[0]) ) + __pyx_t_2 * __pyx_v_c.strides[1]) ))));
 ...
 *     #\Rho = s2 - v2 DOT c2
 */
  __pyx_f_5scipy_6linalg_11cython_blas_dgemm(((char *)"N"), ((char *)"N"), (&__pyx_v_pm), (&__pyx_v_n), (&__pyx_v_pm), (&__pyx_v_alpha), __pyx_v_a0, (&__pyx_v_lda), __pyx_v_u0, (&__pyx_v_lda), (&__pyx_v_beta), __pyx_v_c0, (&__pyx_v_lda));
 ...
 */
  __pyx_f_5scipy_6linalg_11cython_blas_dgemm(((char *)"N"), ((char *)"N"), (&__pyx_v_n), (&__pyx_v_n), (&__pyx_v_pm), (&__pyx_v_zalpha), __pyx_v_v0, (&__pyx_v_n), __pyx_v_c0, (&__pyx_v_lda), (&__pyx_v_alpha), __pyx_v_s0, (&__pyx_v_n));
 ...
 */
  ...
  } else if (unlikely(__pyx_t_5 >= __pyx_v_s.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 330, __pyx_L1_error)
  }
  ...
  if (__pyx_t_6 < 0) {
    ...
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_s.shape[0])) __pyx_t_3 = 0;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_v_s.shape[1];
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_7 >= __pyx_v_s.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 330, __pyx_L1_error)
  }
  ...
  } else if (unlikely(__pyx_t_8 >= __pyx_v_s.shape[0])) __pyx_t_3 = 0;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_v_s.shape[1];
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_9 >= __pyx_v_s.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_3);
    __PYX_ERR(0, 330, __pyx_L1_error)
  }
  __pyx_r = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s.data + __pyx_t_2 * __pyx_v_s.strides[0]) ) + __pyx_t_1 * __pyx_v_s.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s.data + __pyx_t_4 * __pyx_v_s.strides[0]) ) + __pyx_t_5 * __pyx_v_s.strides[1]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s.data + __pyx_t_6 * __pyx_v_s.strides[0]) ) + __pyx_t_7 * __pyx_v_s.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s.data + __pyx_t_8 * __pyx_v_s.strides[0]) ) + __pyx_t_9 * __pyx_v_s.strides[1]) )))));
  goto __pyx_L0;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("det_n2.det_p2", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_6det_n2_15det_p2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6det_n2_14det_p2[] = "\n    Det: add a two rows & columns\n\n    integer :: lda, pm       ! leading dimension and actual size of A\n    real*8  :: a(lda,lda)\n    real*8  :: v2(2,lda),u2(lda,2),s2(2,2),c2(lda,2)\n\n    Input: \n        a(lda,lda), v2(2,lda), u2(lda,2), s2(2,2)\n        all arrays are of the size pm<lda \n\n    Output:    \n        det. ratio @ det_p2\n    ";
static PyObject *__pyx_pw_6det_n2_15det_p2(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_pm;
  int __pyx_v_lda;
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_u = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("det_p2 (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_pm,&__pyx_n_s_lda,&__pyx_n_s_a,&__pyx_n_s_u,&__pyx_n_s_v,&__pyx_n_s_s,&__pyx_n_s_c,0};
    PyObject* values[7] = {0,0,0,0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lda)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 1); __PYX_ERR(0, 297, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 2); __PYX_ERR(0, 297, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_u)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 3); __PYX_ERR(0, 297, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 4); __PYX_ERR(0, 297, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_s)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 5); __PYX_ERR(0, 297, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, 6); __PYX_ERR(0, 297, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "det_p2") < 0)) __PYX_ERR(0, 297, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 7) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_pm = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_pm == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_lda = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_lda == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_u = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_u.memview)) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_v = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_v.memview)) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_s = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_s.memview)) __PYX_ERR(0, 297, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 297, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("det_p2", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 297, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("det_n2.det_p2", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6det_n2_14det_p2(__pyx_self, __pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_u, __pyx_v_v, __pyx_v_s, __pyx_v_c);
...
static PyObject *__pyx_pf_6det_n2_14det_p2(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_pm, int __pyx_v_lda, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_u, __Pyx_memviewslice __pyx_v_v, __Pyx_memviewslice __pyx_v_s, __Pyx_memviewslice __pyx_v_c) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("det_p2", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 297, __pyx_L1_error) }
  if (unlikely(!__pyx_v_u.memview)) { __Pyx_RaiseUnboundLocalError("u"); __PYX_ERR(0, 297, __pyx_L1_error) }
  if (unlikely(!__pyx_v_v.memview)) { __Pyx_RaiseUnboundLocalError("v"); __PYX_ERR(0, 297, __pyx_L1_error) }
  if (unlikely(!__pyx_v_s.memview)) { __Pyx_RaiseUnboundLocalError("s"); __PYX_ERR(0, 297, __pyx_L1_error) }
  if (unlikely(!__pyx_v_c.memview)) { __Pyx_RaiseUnboundLocalError("c"); __PYX_ERR(0, 297, __pyx_L1_error) }
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_6det_n2_det_p2(__pyx_v_pm, __pyx_v_lda, __pyx_v_a, __pyx_v_u, __pyx_v_v, __pyx_v_s, __pyx_v_c, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 297, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "det_n2._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"det_p1", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_1det_p1, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_det_p1},
  {"inv_p1", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_3inv_p1, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_2inv_p1},
  {"det_m1", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_5det_m1, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_4det_m1},
  {"inv_m1", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_7inv_m1, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_6inv_m1},
  {"det_r", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_9det_r, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_8det_r},
  {"inv_r", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_11inv_r, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_10inv_r},
  {"full_inv", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_13full_inv, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_12full_inv},
  {"det_p2", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6det_n2_15det_p2, METH_VARARGS|METH_KEYWORDS, __pyx_doc_6det_n2_14det_p2},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_det_n2(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_det_n2},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("det_p1", (void (*)(void))__pyx_f_6det_n2_det_p1, "double (int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("inv_p1", (void (*)(void))__pyx_f_6det_n2_inv_p1, "void (int, int, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("det_m1", (void (*)(void))__pyx_f_6det_n2_det_m1, "double (int, int, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("inv_m1", (void (*)(void))__pyx_f_6det_n2_inv_m1, "void (int, int, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("det_r", (void (*)(void))__pyx_f_6det_n2_det_r, "double (int, int, __Pyx_memviewslice, int, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("inv_r", (void (*)(void))__pyx_f_6det_n2_inv_r, "void (int, int, __Pyx_memviewslice, int, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("full_inv", (void (*)(void))__pyx_f_6det_n2_full_inv, "double (int, int, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("det_p2", (void (*)(void))__pyx_f_6det_n2_det_p2, "double (int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "dswap", (void (**)(void))&__pyx_f_5scipy_6linalg_11cython_blas_dswap, "void (int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *, __pyx_t_5scipy_6linalg_11cython_blas_d *, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("scipy.linalg.cython_lapack"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "dgetrf", (void (**)(void))&__pyx_f_5scipy_6linalg_13cython_lapack_dgetrf, "void (int *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "dgetri", (void (**)(void))&__pyx_f_5scipy_6linalg_13cython_lapack_dgetri, "void (int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *, __pyx_t_5scipy_6linalg_13cython_lapack_d *, int *, int *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initdet_n2(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initdet_n2(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_det_n2(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_det_n2(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_det_n2(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'det_n2' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_det_n2(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("det_n2", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_det_n2) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "det_n2")) {
      if (unlikely(PyDict_SetItemString(modules, "det_n2", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init det_n2", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init det_n2");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
